...
const FLOWER_POSITIONS = {
  ...
  mobile: {
    'ID7': { x: 94, y: 30 },  // sunshine and rainbows then sud...
    'ID16': { x: 18, y: 70 }, // Having a lovely married life w...
    'ID21': { x: 90, y: 75 }, // I cannaur...
    'ID25': { x: 60, y: 35 }, // a whirlpool...
    'ID33': { x: 33, y: 25 }, // walls closing in...
    'ID35': { x: 75, y: 65 }, // Starts out like a sauna. And t...
    'ID38': { x: 5, y: 30 }, // Drowning...
    'ID53': { x: 45, y: 70 }, // That one pic of the cartoon do...
    'ID67': { x: 10, y: 40 },  // the last bowling pin wobbling ...
    'ID71': { x: 90, y: 40 }  // Being completely submerged in ...
  }
};

// Simple layout storage - one layout for all devices
const LOA_LAYOUT_KEY = 'loa-simple-layout-v19';
...
function getOptimalStaggerDelay() {
  return isMobileDevice() ? 60 : 30; // Smoother stagger on mobile to avoid jagged animation
}
